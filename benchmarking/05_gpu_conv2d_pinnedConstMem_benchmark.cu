...
int main(int argc, char const *argv[]) {
  ...
  // Warmup
  for (int i = 0; i < 10; i++)
    gpu_conv2d_constMem_kernel<<<dim_grid, dim_block>>>(d_N, d_P, new_size,
                                                        new_size);
  ...
  stbi_write_png("data/img_output/gpu_pinnedConst_benchmark_output_img.png",
  ...
  // ----------------------------------------------------------------- //
  // Opening File
  const std::string filename = "./gpu_pinnedConst.txt";
